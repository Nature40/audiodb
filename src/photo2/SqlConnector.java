...
public class SqlConnector {
	...
	public static enum SQL {
		...
		CREATE_TABLE_REVIEW_LIST_SET(
				"CREATE TABLE REVIEW_LIST_SET " +
						"(" +
						"ID VARCHAR(255), " +			
						"PROJECT VARCHAR(255), " +
						"NAME VARCHAR(255), " +	
		...
		INSERT_REVIEW_LIST_SET(
				"INSERT INTO REVIEW_LIST_SET " +
						"(ID, PROJECT, NAME) " +
						"VALUES " +
						"(?, ?, ?)"
				),
		...
		INSERT_REVIEW_LIST(
				"INSERT INTO REVIEW_LIST " +
						"(ID, PROJECT, SET, NAME, LAST_MODIFIED) " +
						"VALUES " +
						"(?, ?, ?, ?, ?)"
				),
		...
		DELETE_REVIEW_LIST_SET("DELETE FROM REVIEW_LIST_SET"),
		...
		DELETE_REVIEW_LIST_SET_BY_ID("DELETE FROM REVIEW_LIST_SET WHERE ID = ?"),
		...
		DELETE_REVIEW_LIST_SET_BY_PROJECT("DELETE FROM REVIEW_LIST_SET WHERE PROJECT = ?"),
		...
		QUERY_REVIEW_LIST_SET_BY_PROJECT("SELECT ID, NAME FROM REVIEW_LIST_SET WHERE PROJECT = ?"),
		
		QUERY_REVIEW_LIST_BY_PROJECT("SELECT ID, SET, NAME FROM REVIEW_LIST WHERE PROJECT = ?"),
		
		QUERY_REVIEW_LIST_BY_SET("SELECT ID, SET, NAME FROM REVIEW_LIST WHERE SET = ?"),
