...
public class SqlConnector {
	...
	public static enum SQL {
		...
		QUERY_REVIEW_LIST_ENTRY_BY_ID_ORDER_BY_RANKING("SELECT PHOTO, NAME, RANKING FROM REVIEW_LIST_ENTRY WHERE ID = ? ORDER BY RANKING DESC");
