...
public abstract class BufferedDataOutputStreamBasic extends OutputStream implements DataOutput {
	...
	public BufferedDataOutputStreamBasic(OutputStream out) {
		this.buf = new byte[DEFAULT_BUFFER_SIZE];
		this.pos = 0;
		this.out = out;
	}

	public BufferedDataOutputStreamBasic(OutputStream out, int size) {
