...
public class BufferedDataOutputStreamLE extends BufferedDataOutputStreamBasic {
	
	public BufferedDataOutputStreamLE(OutputStream out) {
		super(out);
	}
	
	public BufferedDataOutputStreamLE(OutputStream out, int size) {
		super(out, size);
	}
