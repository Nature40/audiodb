...
public class SqlConnector {	
	...
	public static enum SQL {
		...
		QUERY_DATES("SELECT DISTINCT DATE FROM PHOTO WHERE PROJECT = ?"),
		
		QUERY_DATES_AT_LOCATION("SELECT DISTINCT DATE FROM PHOTO WHERE PROJECT = ? AND LOCATION = ?"),
		...
		QUERY_IDS_WITH_DATE_RANGE_NOT_LOCKED_SORT_DATE("SELECT ID FROM PHOTO WHERE PROJECT = ? AND DATE >= ? AND DATE <= ? AND NOT LOCKED ORDER BY DATE"),
		
		QUERY_ALL_IDS("SELECT ID FROM PHOTO"),
		
		QUERY_ALL_IDS_NOT_LOCKED("SELECT ID FROM PHOTO WHERE NOT LOCKED"),
		
		QUERY_IDS_NOT_LOCKED_AT_LOCATION("SELECT ID FROM PHOTO WHERE PROJECT = ? AND LOCATION = ? AND NOT LOCKED"),
		
		QUERY_IDS_NOT_LOCKED_AT_LOCATION_SORT_DATE("SELECT ID FROM PHOTO WHERE PROJECT = ? AND LOCATION = ? AND NOT LOCKED ORDER BY DATE"),
		
		QUERY_IDS_NOT_LOCKED_AT_LOCATION_DATE_RANGE_SORT_DATE("SELECT ID FROM PHOTO WHERE PROJECT = ? AND LOCATION = ? AND DATE >= ? AND DATE <= ? AND NOT LOCKED ORDER BY DATE"),
