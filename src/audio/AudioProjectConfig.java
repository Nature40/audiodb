...
public final class AudioProjectConfig {
	...
	public String toString() {
		return "AudioProjectConfig [project=" + project + ", root_path=" + root_path + ", root_data_path="
				...
				+ player_samplingRate + ", player_fft_window=" + player_fft_window + ", player_time_expansion_factor="
				...
				+ player_fft_cutoff_upper_frequency + ", audio_cache_max_files=" + audio_cache_max_files + "]";
	}
}
