...
public final class AudioProjectConfig {
	...
	public String toString() {
		return "AudioProjectConfig [project=" + project + ", root_path=" + root_path + ", player_spectrum_threshold="
				+ player_spectrum_threshold + ", player_playbackRate=" + player_playbackRate
				+ ", player_preservesPitch=" + player_preservesPitch + ", player_overwriteSamplingRate="
				+ player_overwriteSamplingRate + ", player_samplingRate=" + player_samplingRate + "]";
	}
}
