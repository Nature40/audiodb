...
echo -e "${WHITE}After update it may be needed to run the ./clear_cache.sh script for AudioDB to work properly.${NC}"
echo -e "${WHITE}--------------------------------------------------------------------------------------------------${NC}"
...
wget --directory-prefix=./update https://github.com/Nature40/audiodb/releases/latest/download/package.zip
